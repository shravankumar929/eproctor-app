        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click', '#type', function () {
                    ...
                    {
                        var backup1 = '<div id="quesion_perticular"><hr><h3>Numerical Type</h3><br><h4 id="queLabel">Question No:'+question_num+'</h4><br><textarea rows="3" cols="80" name="' + question_num + '" id="question_num' + question_num + '" placeholder="Enter question Here:"></textarea><div class="ui icon button" id="erase3"><i class="erase icon"></i></div><br><div class="ui input focus"><br><h4>Answer:&nbsp;&nbsp;<input name="NumericAns' + question_num + '" type="text" size="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Marks:&nbsp;&nbsp;<input type="text" size="2"  name="marks' + question_num + '">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Negative Marks:&nbsp;&nbsp;<input type="text" size="2" name="marksNeg' + question_num + '"></h4></div></div><br>&nbsp;<br>&nbsp;<br><input type="hidden" name="type' + question_num + '" value="3"/></div>';
                        backup = backup + backup1;
                        $("#sub_que").before(backup1);
                        question_num = question_num + 1;
                        $("#num_of_questions").val(question_num);
