...
<html>
    ...
    <%
        ...
        try {
            ...
            jumble=Integer.parseInt(session.getAttribute("jumble").toString());
        ...
        obj = new QuestionPaper(test_name, text.toString(), total, total_duration, testTime, total_que,jumble);
