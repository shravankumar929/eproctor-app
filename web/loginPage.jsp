    ...
    <body>
        ...
        <div class="ui one column center aligned grid">
            <div class="column six wide form-holder">
                <h2 class="center aligned header form-head">Login to eProctor</h2>
             
                <form class="ui form" method="post" action="login.jsp">
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <a href="registration.jsp" style="float:left;"><h4>Register</h4></a>
                        <a href="forgotPass.jsp" style="float:right;"><h4>Forgot Password?</h4></a>
                    </div>
