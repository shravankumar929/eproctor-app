    ...
    <div class="ui stackable grid">
        ...
        <div class="item">
            <h3>Accounts</h3>
                ...
                <a class="active item" href="DisplayUsers.jsp">View Accounts</a>
        ...
        <%
            ...
            ResultSet rs = st.executeQuery("select Fname,Role,Email,Photo from Details where status=\'"+1+"\'");
            boolean flag=false;
        %>
        <div class="ui header">
            <br>&nbsp;<br>
         ...
         <form action="deleteAccounts.jsp" method="post" >
                ...
                <tbody>
                    <%
                        ...
                        while(rs.next())
                        {
                            ...
                            out.println("<tr><td></td><td><div class='ui radio checkbox'><input name='validate"+c+"' value='"+rs.getString(3)+ ":2' type='radio'><label>Delete</label></div></td></tr>");
