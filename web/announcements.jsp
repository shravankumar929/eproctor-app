...
<html>
    ...
    <body>
        ...
        <div class="computer tablet only row">
            <div class="ui top fixed inverted menu">
                ...
                <a class="active item" href="announcements.jsp">Announcements</a>
  ...
  &nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>
        ...
        <ul>
        	<li>Mock Test is going to be conducted on Thursday(30-06-2016). Anyone can give this test in between 9AM to 12PM. Duration of the test is 30 minutes. Before giving the Test <a href="registration.jsp">Register</a> on the site.</li>
        </ul>
        </div>
        </div>
